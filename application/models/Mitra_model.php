...
class Mitra_model extends CI_model
{
    ...
    public function instmerchant($data)
    {
        $this->db->insert('merchant', $data);
    }
    public function tambahkanmitra($datamitra,$datamerchant, $databerkas, $datasaldo)
    {
        $this->db->insert('mitra', $datamitra);
        $this->db->insert('merchant', $datamerchant);
    ...
    public function datakategoribyid($id)
    {
        $this->db->select('*');
        $this->db->from('category_merchant');
        $this->db->where('id_kategori_merchant',$id);
        return $this->db->get()->row_array(); 
       // return $this->db->get_where('category_merchant', ['id_kategori_merchant' => $id])->row_array();
    }
    ...
    public function ubahcm($data, $id)
    {
        ...
        $this->db->set('foto_kategori', $data['foto_kategori']);
        $this->db->where('id_kategori_merchant', $id);
