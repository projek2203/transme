...
if (version_compare(PHP_VERSION, '5.6.0', '<') ) exit("Sorry, this version of PHPMailer will only run on PHP version 5 or greater!\n");
...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'reply@kelanacorps.xyz';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'reply@kelanacorps.xyz';
   ...
   * @var string
   */
  public $Sender            = 'reply@kelanacorps.xyz';
  ...
  */
   ...
   * @var string
   */
  public $Host          = 'mail.kelanacorps.xyz';
   ...
   * @var string
   */
  public $Username      = 'reply@kelanacorps.xyz';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'NQW7MR55b{Zz';
