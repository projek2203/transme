...
<main class="page-content">
    <div class="card border shadow-none">
        ...
        <div class="tab-pane fade show active" id="tab1" role="tabpanel">
            <table id="dashboard-trx" class="table table-striped table-hover dt-responsive display nowrap" data-info="false" cellspacing="0" width="100%">
                <thead>
                <tr>
                <th>No</th>
                <th>#ID</th>
        ...
        <div class="tab-pane fade" id="tab2" role="tabpanel">
            <table id="peltable2" class="table table-striped table-hover dt-responsive display nowrap" data-info="false" cellspacing="0" width="100%">
                <thead>
                <tr>
                <th>No</th>
                <th>#ID</th>
