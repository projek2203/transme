  ...
  <!--plugins-->
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBLrW7IzWzbII0Sex8zrRmCyAZRT7iWqUs&callback=initMap" async defer></script>
<!-- partial -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBLrW7IzWzbII0Sex8zrRmCyAZRT7iWqUs&callback=drivermap" async defer></script>
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=true&libraries=places">
</script>
<script type="text/javascript" src='https://maps.google.com/maps/api/js?key=AIzaSyBLrW7IzWzbII0Sex8zrRmCyAZRT7iWqUs&sensor=false&libraries=places'></script>
