       ...
       <?php endif; ?>
        ...
        <?= form_open_multipart('paket/editpaket/' . $paket['id']); ?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="title" name="nama" placeholder="Ex: Dokumen" value="<?= $paket['nama'] ?>" required>
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputEnterYourName" class="col-sm-2 col-form-label">Keterangan</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="title" name="keterangan" placeholder="Dokumen Kantor" value="<?= $paket['keterangan'] ?>" required>
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputEnterYourName" class="col-sm-2 col-form-label">Biaya</label>
                <div class="col-sm-9">
                    <input type="number" class="form-control" id="title" name="harga" placeholder="0" value="<?= $paket['harga'] ?>" required>
                </div>
            </div>
            <div class="row mb-3">
