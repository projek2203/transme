...
<main class="page-content">
    <div class="card border shadow-none">
            <div class="card-header py-3">
                <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                      <h5 class="mb-0">Ubah Data Bank</h5>
                    </div>
                </div>
            </div>
        ...
        <?php endif; ?>
        <!-- Konten -->
        <?= form_open_multipart('pengaturan/ubahbank/' . $transfer['id_bank']); ?>
            <div class="row mb-3">
             ...
             <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="title" name="nama_bank" value="<?= $transfer['nama_bank']; ?>" placeholder="BRI" required>
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputEnterYourName" class="col-sm-2 col-form-label">No Rekening</label>
                <div class="col-sm-9">
                    <input type="number" class="form-control" id="title" name="rekening_bank" value="<?= $transfer['rekening_bank']; ?>" placeholder="Nomor Rekening" required>
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputEnterYourName" class="col-sm-2 col-form-label">Status</label>
                <div class="col-sm-9">
                    <select class="form-control custom-select  mt-15" name="status_bank" style="width:100%">
